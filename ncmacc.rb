...
COMMUNITY_PROGRAMS = [["Children's Chorus", "childrens_chorus"],
...
PROGRAMS = [["Community", COMMUNITY_PROGRAMS, "Free programs for community youths."],
            ["Music", MUSIC_PROGRAMS, "For musicians of all ages."],
